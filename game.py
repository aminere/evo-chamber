...
class Game:
    def __init__(self):
        ...
        firstWorker = character.Character('farmer', config.firstWorkerPos, 33)
        self.tiles[utils.getTileIndex(config.firstWorkerPos)] = (rawTile, 0, firstWorker)
        self.workers = [firstWorker]
